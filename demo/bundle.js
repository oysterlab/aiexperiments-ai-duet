      ...
      if (Math.abs((now - startTime) / 1000 - signal.time) < 1) {
        ...
        if (signal.from == 'ai' && signal.type == 'keyDown') {
          ...
          if (borns[0]) {
            ...
            var vRadius = 800 + 200 * Math.random();
  ...
  socket.on('toss-signal', function (signal) {
    ...
    if (signal.from == 'user' && signal.type == 'keyDown') {
      ...
      if (borns[0]) {
        ...
        var r = Math.random() * 2 * Math.PI;
        var vRadius = 50 + 100 * Math.random();
        borns[0].mX = Math.cos(r) * vRadius + WIDTH * 0.5 - borns[0].bX;
        borns[0].mY = Math.sin(r) * vRadius + HEIGHT * 0.5 - borns[0].bY;
        borns[0].mRad = r;
        borns[0].vRadius = vRadius;
    ...
    value: function update(t) {
      ...
      if (state == 'born') {
        ...
        if (this.mRemainLife > 0) {
          ...
          var r = 1. - this.mRemainLife / this.mLife;
        ...
        var k = Math.sin(4 * Math.PI * 2 * t * 0.00005) * 10;
...
},{"../transport":16,"component-inherit":10,"debug":11,"engine.io-parser":23,"parseqs":32,"xmlhttprequest-ssl":22,"yeast":44}],21:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":10,"debug":11,"engine.io-parser":23,"parseqs":32,"ws":7,"yeast":44}],22:[function(require,module,exports){
(function (global){
...
},{"./on":37,"./socket":38,"backo2":4,"component-bind":8,"component-emitter":9,"debug":11,"engine.io-client":13,"indexof":28,"socket.io-parser":41}],37:[function(require,module,exports){
...
},{"./on":37,"component-bind":8,"component-emitter":9,"debug":11,"parseqs":32,"socket.io-parser":41,"to-array":43}],39:[function(require,module,exports){
(function (global){
